			...
			<main class="page-shell">
				<header class="page-heading">
					...
					<p class="page-heading__description">
						This route previews the MVP-safe components before real
						functionality is wired.
					</p>
				</header>
				...
				<section class="preview-grid">
					...
					<article class="panel preview-card">
						...
						<div class="chip-row">
							<c:forEach
								var="chip"
								items="${componentPage.sampleChips}"
							>
								<ui:chip
									label="${chip.label}"
									active="${chip.active}"
					...
					<article class="panel preview-card">
						...
						<div class="create-stack">
							...
							<ui:selectField
								label="Skill level"
								name="previewSkill"
								options="${componentPage.skillLevels}"
							/>
							<ui:textArea
								label="Description"
					...
					<article class="panel preview-card">
						...
						<ui:card
							...
							href="${pageContext.request.contextPath}${componentPage.sampleEvent.href}"
						>
							<div
								class="event-card__media ${componentPage.sampleEvent.mediaClass}"
							>
								<span class="event-card__badge"
									><c:out
										value="${componentPage.sampleEvent.badge}"
								/></span>
							</div>
							<div class="event-card__body">
								<span class="event-card__sport"
									><c:out
										value="${componentPage.sampleEvent.sport}"
								/></span>
								<h3 class="event-card__title">
									<c:out
										value="${componentPage.sampleEvent.title}"
									/>
								</h3>
								<div class="event-card__meta">
									<span
										><c:out
											value="${componentPage.sampleEvent.venue}"
									/></span>
									<span
										><c:out
											value="${componentPage.sampleEvent.schedule}"
									/></span>
									<span
										><c:out
											value="${componentPage.sampleEvent.priceLabel}"
									/></span>
								</div>
							</div>
						</ui:card>
