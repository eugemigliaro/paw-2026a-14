							...
							<%@ include file="/WEB-INF/views/includes/site-header.jspf" %>
								...
								<main class="page-shell account-shell">
									<section class="panel account-panel">
										...
										<form:form method="post" action="${accountAction}"
											modelAttribute="accountProfileForm" cssClass="account-form"
											id="account-edit-form" data-account-edit-form="true"
											...
											<%-- Image at top --%>
												<div class="field">
													...
													<section
														class="account-profile-media account-profile-media--editable">
														...
														<label class="field" for="account-profile-image">
															...
															<input id="account-profile-image" name="profileImage"
																type="file" class="field__control"
													...
													<%-- First + Last name side by side --%>
														<div class="account-summary__name-row">
															<label class="field" for="account-name">
																...
																<form:errors path="name" cssClass="field__error"
																	element="span" />
															</label>
															<label class="field" for="account-last-name">
																...
																<form:errors path="lastName" cssClass="field__error"
																	element="span" />
															</label>
														</div>
														...
														<label class="field" for="account-username">
															...
															<form:errors path="username" cssClass="field__error"
																element="span" />
														</label>
														...
														<label class="field" for="account-phone">
															...
															<form:input path="phone" id="account-phone" type="tel"
																cssClass="field__control"
																placeholder="${phonePlaceholder}" autocomplete="tel" />
															<form:errors path="phone" cssClass="field__error"
																element="span" />
														</label>
														...
														<div class="account-actions">
															...
															<ui:button label="${accountCancelLabel}"
																href="${accountHref}" variant="secondary" />
														</div>
										</form:form>
									</section>
								</main>
