					...
					<form:form
						...
						<article class="panel form-card">
							...
							<div class="create-stack">
								...
								<label class="field" for="match-title">
									<span class="field__label"><spring:message code="host.form.title" /></span>
									<form:input
										path="title"
										id="match-title"
										cssClass="field__control"
								...
								<label class="field" for="match-description">
									<span class="field__label"><spring:message code="host.form.description" /></span>
									<form:textarea
										path="description"
						...
						<article class="panel form-card">
							...
							<div class="form-card__grid form-card__grid--three">
								...
								<label class="field" for="match-price">
									<span class="field__label"><spring:message code="host.form.pricePerPlayer" /></span>
									<form:input
										path="pricePerPlayer"
										id="match-price"
										type="number"
						...
						<article class="panel upload-card">
							...
							<label class="field" for="match-banner-image">
								...
								<span class="field__hint"><spring:message code="host.form.bannerImage.hint" /></span>
							</label>
