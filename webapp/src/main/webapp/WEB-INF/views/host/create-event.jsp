...
<body>
	...
	<main class="page-shell">
		...
		<header class="page-heading">
			...
			<h1 class="page-heading__title"><c:out value="${createPage.title}" /></h1>
		...
		<article class="panel upload-card">
			...
			<div class="upload-card__content">
				<strong><c:out value="${createPage.uploadHint}" /></strong>
				<span><c:out value="${createPage.uploadCaption}" /></span>
			</div>
			</div>
		</article>
